...
const uint8_t DeviceDescriptor[SIZ_DEVICE_DESC] =
  {
    0x12,                       /*bLength */
    DEVICE_DESC_TYPE, /*bDescriptorType*/
    0x00,                       /*bcdUSB */
    0x02,
    0x00,                       /*bDeviceClass*/
...
const uint8_t ConfigDescriptor[SIZ_CONFIG_DESC] =
  {
    ...
    CONFIG_DESC_TYPE, /* bDescriptorType: Configuration */
    SIZ_CONFIG_DESC,
    ...
    0x00,         /*iConfiguration: Index of string descriptor describing
                                     the configuration*/
    0xE0,         /*bmAttributes: bus powered and remote wakeup */
    0x32,         /*MaxPower 100 mA: this current is used for detecting Vbus*/

    /************** Descriptor of Joystick Mouse interface ****************/
    /* 09 */
    0x09,         /*bLength: Interface Descriptor size*/
    INTERFACE_DESC_TYPE,/*bDescriptorType: Interface descriptor type*/
    ...
    ENDPOINT_DESC_TYPE, /*bDescriptorType:*/

    0x81,          /*bEndpointAddress: Endpoint Address (IN)*/
    0x03,          /*bmAttributes: Interrupt endpoint*/
    0x04,          /*wMaxPacketSize: 4 Byte max */
    0x00,
    0xff,          /*bInterval: Polling Interval (32 ms)*/
    /* 34 */
  }
...
const uint8_t StringLangID[SIZ_STRING_LANGID] = // 0
  {
    SIZ_STRING_LANGID,
    STRING_DESC_TYPE,
    0x09,
...
const uint8_t StringVendor[SIZ_STRING_VENDOR] =  //1
  {
    SIZ_STRING_VENDOR, /* Size of Vendor string */
    STRING_DESC_TYPE,  /* bDescriptorType*/
...
const uint8_t StringProduct[SIZ_STRING_PRODUCT] = //2
  {
...
uint8_t StringSerial[SIZ_STRING_SERIAL] =  //3
  {
